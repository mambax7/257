...
function upload_form($uploadlimit, $passedalbum)
{
    ...
    <p id="addUploadBoxes"><a href="javascript:addUploadBoxes('place','filetemplate',5)" title="<?php echo gettext('Does not reload!'); ?>">+ <?php echo gettext('Add more upload boxes'); ?></a>
        <small>
            <?php echo gettext('(will not reload the page, but remember your upload limits!)'); ?></small>
    </p>
