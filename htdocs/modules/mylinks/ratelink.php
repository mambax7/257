...
if (!empty($_POST['submit'])) {
    ...
    $lid    = MylinksUtility::mylinks_cleanVars($_POST, 'lid', 0, 'int', ['min' => 0]);
    $cid    = MylinksUtility::mylinks_cleanVars($_POST, 'cid', 0, 'int', ['min' => 0]);
    $rating = MylinksUtility::mylinks_cleanVars($_POST, 'rating', 0, 'int', ['min' => 0]);
    ...
    */
    ...
    $lid    = MylinksUtility::mylinks_cleanVars($_GET, 'lid', 0, 'int', ['min' => 0]);
    $cid    = MylinksUtility::mylinks_cleanVars($_GET, 'cid', 0, 'int', ['min' => 0]);
