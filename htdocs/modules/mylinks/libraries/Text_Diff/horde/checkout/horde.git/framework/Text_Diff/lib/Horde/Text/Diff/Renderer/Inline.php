...
class Horde_Text_Diff_Renderer_Inline extends Horde_Text_Diff_Renderer
{
    ...
    protected function _changed($orig, $final)
    {
        ...
        if ('characters' == $this->_split_level) {
        ...
        $renderer = new Horde_Text_Diff_Renderer_inline(array_merge($this->getParams(), ['split_level' => $this->_split_characters ? 'characters' : 'words']));
