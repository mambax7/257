...
define(
    '_AM_WFL_FCATEGORY_SUBGROUPPROMPT',
       "Permission de soumission de cat&eacute;gories:<div style='padding-top :8px;'><span style='font-weight :normal;'>S&eacute;lectionnez les groupes d'utilisateurs qui auront la possibilit&eacute; de proposer de nouveaux liens dans cette cat&eacute;gorie.</span></div>"
);
...
define(
    '_AM_WFL_MINDEX_PAGEINFOTXT',
       '<ul><li>D&eacute;tails de la page principale de WF-links.</li><li>Vous pouvez facilement changer le logo, le titre, l\'en-t&ecirc;te et le pied de page de l\'index principal pour les adapter &agrave; vos besoins.</li></ul><br>Note :Le logo choisi sera employ&eacute; dans toutes les pages de WF-links.'
);
...
define(
    '_AM_WFL_LISTBROKEN',
       "Afficher les liens qui sont potentiellement bris&eacute;s. NB :Le r&eacute;sultat peut ne pas &ecirc;tre pr&eacute;cis et doit &ecirc;tre pris comme une indication approximative.<br><br>Veuillez v&eacute;rifier que le lien existe d'abord avant de prendre les mesures n&eacute;cessaires.<br><br>"
);
