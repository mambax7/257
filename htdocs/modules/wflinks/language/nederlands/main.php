...
define(
    '_MD_WFL_SUB_SNEWMNAMEDESC',
       '<ul><li>Alle nieuwe inzendingen zijn onderwerp van beoordeling. Er kan enige tijd overheen gaan voordat ze in de index worden opgenomen.</li><li>Wij behouden ons het recht voor om ingezonden linken te weigeren of de inhoud te wijzigen zonder overleg of goedkeuring.</li></ul>'
);
