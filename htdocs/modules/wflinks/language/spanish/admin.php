...
define(
    '_AM_WFL_PERM_PERMSNOTE',
       '<div><b>NOTA:</b> Por favor sepa que no solo debe configurar los permisos aquí sino que también debe hacerlo en la administración de grupos de ImpressCMS. Para ello acceda a <b>Sistema > Grupos</b> y elija los grupos correspondientes para configurar su acceso al módulo y a los bloques.</div>'
);
...
define(
    '_AM_WFL_MINDEX_PAGEINFOTXT',
       '<ul><li>Detalles de la página principal del módulo WF-links.</li><li>Puede cambiar de forma sencilla la imagen del logo, el encabezado principal y el pié de página así como la alineación de los mismos.</li></ul><br>Nota: La imagen del logo que elija será usada para WF-links.'
);
